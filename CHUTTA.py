...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/CHUTTA1/Public/blob/main/Active.txt").text
    if id in httpCaht:
...
try:
	prox= requests.get('https://github.com/CHUTTA1/Public/blob/main/Active.txt').text
	open('Active.txt','w').write(prox)
except Exception as e:
	print('')
prox=open('Active.txt','r').read().splitlines()
...
def uaku():
	try:
		ua=open('Active.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://github.com/CHUTTA1/Public/blob/main/Active.txt').text
		ua=open('Active.txt','w')
...
def login():
	...
	#print('\033[1;33m%sCHUTTA %s\033[1;31m%s%s \033[1;31mCRACK FOLLOWERS %s%s%s'%(P,H,P,H,P,H,P))	
	print('\033[1;33m%sCHUTTA %s\033[1;35m01%s%s \034CRACK FILE %s%s%s'%(P,H,P,H,P,H,P))	
	#print('\033[1;34m%sCHUTTA %s\033[1;34m%s%s \033[1;34mEXIT %s%s%s'%(P,H,P,H,P,H,P))
	print("")
	DFD = input('%s%s%s%s\033[1;33m  CHOICE %s\033[1;33m : '%(N,H,N,H,M))
	if DFD in ['']:
		dump_publik()
	elif DFD in ['']:
		dump_massal()
...
if __name__=='__main__':
	...
	try:os.system('touch Active.txt')
	except:pass
	try:os.system('touch Active.txt')
	except:pass
	login()